	...
	<div class="container text-dark">
		<div class="d-flex justify-content-center mx-5 py-4 bgCartel rounded">
			<div class="bgPergamino rounded">
				<h2 class="fw-bolder text-center my-3 mx-5"><%=rb.getString("eligeUnaOpcion")%></h2>
			</div>
		</div>
			...
			<div class="bgPergamino rounded">
				<form action="<%=request.getContextPath()%>/ControllerGame"
					...
					<div class="grid-container-4c texto-justificado">
						...
						<input class="btn btn-secondary mb-4 mx-5" type="submit"
							id="btnOpcion1" name="submitPageBtn"
							value="<%=rb.getString("sbmtLabia")%>"> <input
							class="btn btn-secondary mb-4 mx-5" type="submit"
							id="btnContinuar" name="submitPageBtn"
							value="<%=rb.getString("sbmtAgilidad")%>"> <input
							class="btn btn-secondary mb-4 mx-5" type="submit"
							id="btnContinuar" name="submitPageBtn"
							value="<%=rb.getString("sbmtMagia")%>"> <input
							class="btn btn-secondary mb-4 mx-5" type="submit"
							id="btnContinuar" name="submitPageBtn"
							value="<%=rb.getString("sbmtHuir")%>">
					</div>
				</form>
			</div>
		</div>
