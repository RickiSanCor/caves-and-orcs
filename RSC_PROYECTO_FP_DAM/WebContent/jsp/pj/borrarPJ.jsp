...
<body>
	<div class="container text-dark">
		...
		<div class="container d-flex justify-content-center text-dark">
			<%
				Personaje personaje = (Personaje) session.getAttribute("pjParaBorrar");
			%>
			<fieldset class="mt-5 bgPergamino rounded">
				<div class="m-3"><%=rb.getString("confirmBorrar")%>
					<strong><%=personaje.getNombre()%></strong>?
				</div>
				<form class="text-center"
					action="<%=request.getContextPath()%>/ControllerPJ" method="post">
					<input class="btn btn-danger m-3" type="submit" id="btnBorrarPJ"
						name="submitPageBtn" value="<%=rb.getString("sbmtBorrarPJ")%>">
					<input class="btn btn-secondary m-3" type="submit" id="btnCancelar"
